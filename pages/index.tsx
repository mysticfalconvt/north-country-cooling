...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>North Country Cooling</title>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="col-span-1 prose md:prose-lg lg:prose-xl">
                ...
                <p className="text-xl">
                  ...
                  repair, and maintenance of all makes and models of air
                  conditioning and heating systems. We also offer duct cleaning
                  and air quality testing.
                </p>
                <p className="text-xl">
                  We pride ourselves on our quality of work and our attention to
                  detail. We are committed to providing our customers with the
              ...
              <div className="col-span-1">
                <div className="card w-64 lg:w-96 bg-base-200 shadow-xl mx-auto z-0">
                  <figure>
                    <Image
